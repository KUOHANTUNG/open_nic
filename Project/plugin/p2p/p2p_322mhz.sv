...
//  wire        [31:0]                udp_tx_pkg_counter_sta;      
  ...
  wire                              axis_tx_adapter_to_transfer_tvalid;
  wire      [511:0]                 axis_tx_adapter_to_transfer_tdata;
  wire      [63:0]                  axis_tx_adapter_to_transfer_tkeep;
  wire                              axis_tx_adapter_to_transfer_tlast; 
  wire                              axis_tx_adapter_to_transfer_tuser_err;  
  wire                              axis_tx_adapter_to_transfer_tready;  
    
  wire                              axis_tx_transfer_to_stack_tvalid;
  wire      [511:0]                 axis_tx_transfer_to_stack_tdata;
  wire      [63:0]                  axis_tx_transfer_to_stack_tkeep;
  wire                              axis_tx_transfer_to_stack_tlast; 
...
----------------------------------------------------------------------------------------------------------------*/
    wire             axis_transfer_network_stack_udp_meta_tvalid  ;
    wire  [175:0]    axis_transfer_network_stack_udp_meta_tdata   ; 
    wire             axis_transfer_network_stack_udp_meta_tready  ;
    
    wire             axis_network_stack_transfer_udp_meta_tvalid  ;
    wire  [175:0]    axis_network_stack_transfer_udp_meta_tdata   ; 
    wire             axis_network_stack_transfer_udp_meta_tready  ;
...
//    wire             axis_loopback_udp_data_tready   ;
    ...
    transfer#(
        ...
        .clk(cmac_clk[0]),                        
        .rst_n(cmac_rstn[0]),                      
        .s_axis_tx_tvalid(axis_tx_adapter_to_transfer_tvalid),           
        .s_axis_tx_tdata(axis_tx_adapter_to_transfer_tdata),            
        .s_axis_tx_tkeep(axis_tx_adapter_to_transfer_tkeep),            
        .s_axis_tx_tlast(axis_tx_adapter_to_transfer_tlast),            
        .s_axis_tx_tuser_err(axis_tx_adapter_to_transfer_tuser_err),        
        .s_axis_tx_tready(axis_tx_adapter_to_transfer_tready),           
                                    
        .s_axis_udp_rx_meta_tvalid(axis_network_stack_transfer_udp_meta_tvalid),  
        .s_axis_udp_rx_meta_tdata(axis_network_stack_transfer_udp_meta_tdata),   
        .s_axis_udp_rx_meta_tready(axis_network_stack_transfer_udp_meta_tready),  
                                    
        .m_axis_udp_tx_meta_tvalid(axis_transfer_network_stack_udp_meta_tvalid),  
        .m_axis_udp_tx_meta_tdata(axis_transfer_network_stack_udp_meta_tdata),   
        .m_axis_udp_tx_meta_tready(axis_transfer_network_stack_udp_meta_tready),  
                                    
                                    
        .m_axis_tx_tvalid(axis_tx_transfer_to_stack_tvalid),           
        .m_axis_tx_tdata(axis_tx_transfer_to_stack_tdata),            
        .m_axis_tx_tkeep(axis_tx_transfer_to_stack_tkeep),            
        .m_axis_tx_tlast(axis_tx_transfer_to_stack_tlast),            
        .m_axis_tx_tuser_size(axis_tx_transfer_to_stack_tuser_size),       
        .m_axis_tx_tready(axis_tx_transfer_to_stack_tready)            
    );
...
//---------------------------------------------------------------------------------------------------------------    
    ...
    network_stack network_stack_inst(
        ...
        .m_axis_rx_udp_meta_tvalid(axis_network_stack_transfer_udp_meta_tvalid),
        .m_axis_rx_udp_meta_tdata(axis_network_stack_transfer_udp_meta_tdata), 
        .m_axis_rx_udp_meta_tready(axis_network_stack_transfer_udp_meta_tready),
                                 
        .s_axis_tx_udp_meta_tvalid(axis_transfer_network_stack_udp_meta_tvalid),
        .s_axis_tx_udp_meta_tdata({axis_tx_transfer_to_stack_tuser_size,axis_transfer_network_stack_udp_meta_tdata[159:128],axis_transfer_network_stack_udp_meta_tdata[31:0],96'b0}), 
        .s_axis_tx_udp_meta_tready(axis_transfer_network_stack_udp_meta_tready),
                                
        .m_axis_rx_udp_data_tvalid(axis_rx_322mhz_stack_to_adapter_tvalid),
        .m_axis_rx_udp_data_tdata (axis_rx_322mhz_stack_to_adapter_tdata), 
        .m_axis_rx_udp_data_tkeep (axis_rx_322mhz_stack_to_adapter_tkeep), 
        .m_axis_rx_udp_data_tlast (axis_rx_322mhz_stack_to_adapter_tlast), 
        .m_axis_rx_udp_data_tready(axis_rx_322mhz_stack_to_adapter_tready),
                                
        .s_axis_tx_udp_data_tvalid(axis_tx_transfer_to_stack_tvalid ),
        .s_axis_tx_udp_data_tdata (axis_tx_transfer_to_stack_tdata  ), 
        .s_axis_tx_udp_data_tkeep (axis_tx_transfer_to_stack_tkeep  ), 
        .s_axis_tx_udp_data_tlast (axis_tx_transfer_to_stack_tlast  ), 
        .s_axis_tx_udp_data_tready(axis_tx_transfer_to_stack_tready),
...
//        .udp_tx_pkg_counter_sta(udp_tx_pkg_counter_sta),        
    ...
    axi_stream_register_slice #(
      ...
      .m_axis_tvalid (axis_tx_adapter_to_transfer_tvalid),
      .m_axis_tdata  (axis_tx_adapter_to_transfer_tdata),
      .m_axis_tkeep  (axis_tx_adapter_to_transfer_tkeep),
      .m_axis_tlast  (axis_tx_adapter_to_transfer_tlast),
      .m_axis_tid    (),
      .m_axis_tdest  (),
      .m_axis_tuser  (axis_tx_adapter_to_transfer_tuser_err),
      .m_axis_tready (axis_tx_adapter_to_transfer_tready),
