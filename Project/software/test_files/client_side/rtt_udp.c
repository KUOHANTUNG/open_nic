// rtt_udp_wait.c
// Build: gcc -O2 -march=native -Wall -Wextra -o rtt_udp_wait rtt_udp_wait.c
// Run:   taskset -c 2 ./rtt_udp_wait <server_ip> <server_port> <count> [local_port] [timeout_ms] [max_retry]
//
// Example (match your trace: local_port=5001):
//   taskset -c 2 ./rtt_udp_wait 10.0.0.1 5000 500 5001 500 20
...
int main(int argc, char **argv) {
    ...
    // Fixed payload (32 bytes) exactly as you gave
    ...
    // Bind local port (important if server expects source port = 5001)
